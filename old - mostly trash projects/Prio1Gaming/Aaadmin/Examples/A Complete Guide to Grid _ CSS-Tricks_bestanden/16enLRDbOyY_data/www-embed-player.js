...
;function Ve(a,b,c,d,e){var f={};f.eventTimeMs=Math.round(d||L());f[a]=b;f.context={lastActivityMs:String(d?-1:De())};a=Q("web_system_health_gel2")&&"systemHealthCaptured"==a?"log_event2":"log_event";Qe({endpoint:a,payload:f,Y:e},c)}
...
timeout:d.timeout,withCredentials:!0},f=Ob();f&&(e.headers.Authorization=f,e.headers["X-Goog-AuthUser"]=N("SESSION_INDEX",0));var g="",h=a.b.Ga;h&&(g=h);f&&!g&&(e.headers["x-origin"]=window.location.origin);ee(""+g+rf(a.b.innertubeApiVersion,b,c)+"?alt=json&key="+a.b.innertubeApiKey,e)}
...
;var U={},Hf=(U["api.invalidparam"]=2,U.auth=150,U["drm.auth"]=150,U["heartbeat.net"]=150,U["heartbeat.servererror"]=150,U["heartbeat.stop"]=150,U["html5.unsupportedads"]=5,U["fmt.noneavailable"]=5,U["fmt.decode"]=5,U["fmt.unplayable"]=5,U["html5.missingapi"]=5,U["html5.unsupportedlive"]=5,U["drm.unavailable"]=5,U);var If={cupcake:1.5,donut:1.6,eclair:2,froyo:2.2,gingerbread:2.3,honeycomb:3,"ice cream sandwich":4,jellybean:4.1,kitkat:4.4,lollipop:5.1,marshmallow:6,nougat:7.1},Jf;var Kf=La;Kf=Kf.toLowerCase();if(-1!=Kf.indexOf("android")){var Lf=Kf.match(/android\D*(\d\.\d)[^\;|\)]*[\;\)]/);if(Lf)Jf=parseFloat(Lf[1]);else{var Mf=[],Nf=0,Of;for(Of in If)Mf[Nf++]=Of;var Pf=Kf.match("("+Mf.join("|")+")");Jf=Pf?If[Pf[0]]:0}}else Jf=void 0;var Qf=['video/mp4; codecs="avc1.42001E, mp4a.40.2"','video/webm; codecs="vp8.0, vorbis"'],Rf=['audio/mp4; codecs="mp4a.40.2"'];function Sf(a){var b=u("yt.player.utils.videoElement_");b||(b=document.createElement("VIDEO"),t("yt.player.utils.videoElement_",b,void 0));try{if(!b.pause)return"html5.missingapi";if(b.canPlayType){a=a?Qf:Rf;for(var c=0;c<a.length;c++)if(b.canPlayType(a[c]))return null}return"fmt.noneavailable"}catch(d){return"html5.missingapi"}}
;var Tf=u("ytLoggingLatencyUsageStats_")||{};t("ytLoggingLatencyUsageStats_",Tf,void 0);var Uf=0;function Vf(a){Tf[a]=Tf[a]||{count:0};var b=Tf[a];b.count++;b.time=L();Uf||(Uf=oe(Wf,0));return 10<b.count?(11==b.count&&ke(Error("CSI data exceeded logging limit with key: "+a),0==a.indexOf("info")?"WARNING":"ERROR"),!0):!1}
function Wf(){var a=L(),b;for(b in Tf)6E4<a-Tf[b].time&&delete Tf[b];Uf=0}
;function Xf(a,b){this.version=a;this.args=b}
;function Yf(a){this.topic=a}
Yf.prototype.toString=function(){return this.topic};var Zf=u("ytPubsub2Pubsub2Instance")||new I;I.prototype.subscribe=I.prototype.subscribe;I.prototype.unsubscribeByKey=I.prototype.D;I.prototype.publish=I.prototype.K;I.prototype.clear=I.prototype.clear;t("ytPubsub2Pubsub2Instance",Zf,void 0);var $f=u("ytPubsub2Pubsub2SubscribedKeys")||{};t("ytPubsub2Pubsub2SubscribedKeys",$f,void 0);var ag=u("ytPubsub2Pubsub2TopicToKeys")||{};t("ytPubsub2Pubsub2TopicToKeys",ag,void 0);var bg=u("ytPubsub2Pubsub2IsAsync")||{};t("ytPubsub2Pubsub2IsAsync",bg,void 0);
t("ytPubsub2Pubsub2SkipSubKey",null,void 0);function cg(a,b){var c=u("ytPubsub2Pubsub2Instance");c&&c.publish.call(c,a.toString(),a,b)}
;function dg(){var a=N("TIMING_TICK_EXPIRATION");a||(a={},M("TIMING_TICK_EXPIRATION",a));return a}
function eg(){var a=dg(),b;for(b in a)pe(a[b]);M("TIMING_TICK_EXPIRATION",{})}
;function fg(a,b){Xf.call(this,1,arguments)}
n(fg,Xf);function gg(a,b){Xf.call(this,1,arguments)}
n(gg,Xf);var hg=new Yf("aft-recorded"),ig=new Yf("timing-sent");var V=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};var jg=y().toString();var kg={vc:!0},lg={ad_allowed:"adTypesAllowed",ad_at:"adType",ad_cpn:"adClientPlaybackNonce",ad_docid:"adVideoId",yt_ad_an:"adNetworks",p:"httpProtocol",t:"transportProtocol",cpn:"clientPlaybackNonce",csn:"clientScreenNonce",docid:"videoId",is_nav:"isNavigation",yt_lt:"loadType",yt_ad:"isMonetized",nr:"webInfo.navigationReason",ncnp:"webInfo.nonPreloadedNodeCount",plid:"videoId",paused:"playerInfo.isPausedOnLoad",fmt:"playerInfo.itag",yt_pl:"watchInfo.isPlaylist",yt_ad_pr:"prerollAllowed",yt_red:"isRedSubscriber",
st:"serverTimeMs",vph:"viewportHeight",vpw:"viewportWidth",yt_vis:"isVisible"},mg="ap c cver ei srt yt_fss yt_li ba vpil vpni yt_eil pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt pc prerender psc rc start yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),ng="isNavigation isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber isVisible watchInfo.isPlaylist".split(" "),og=!1;
function pg(a){if("_"!=a[0]){var b=a;V.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),V.mark(b))}b=qg();var c=L();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;b=dg();if(c=b[a])pe(c),b[a]=0;rg()["tick_"+a]=void 0;L();Q("csi_on_gel")?(b=sg(),"_start"==a?Vf("baseline_"+b)||Ve("latencyActionBaselined",{clientActionNonce:b},Ye,void 0):Vf("tick_"+a+"_"+b)||Ve("latencyActionTicked",{tickName:a,clientActionNonce:b},Ye,void 0),a=!0):a=!1;if(a=!a)a=!u("yt.timing.pingSent_");if(a&&(b=O("TIMING_ACTION"),
a=qg(),u("ytglobal.timingready_")&&b&&a._start&&(b=tg()))){Q("tighter_critical_section")&&!og&&(cg(hg,new fg(Math.round(b-a._start),void 0)),og=!0);b=!0;c=N("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&ug()}}
function vg(){var a=wg().info.yt_lt="hot_bg";rg().info_yt_lt=a;if(Q("csi_on_gel"))if("yt_lt"in lg){var b={},c=lg.yt_lt;0<=Fa(ng,c)&&(a=!!a);c=c.split(".");for(var d=b,e=0;e<c.length-1;e++)d[c[e]]=d[c[e]]||{},d=d[c[e]];b[c[c.length-1]]=a;a=sg();c=Object.keys(b).join("");Vf("info_"+c+"_"+a)||(b.clientActionNonce=a,Ve("latencyActionInfo",b,Ye))}else 0<=Fa(mg,"yt_lt")||P(Error("Unknown label yt_lt logged with GEL CSI."))}
function tg(){var a=qg();if(a.aft)return a.aft;for(var b=N("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
function ug(){eg();if(!Q("csi_on_gel")){var a=qg(),b=wg().info,c=a._start,d;for(d in a)if(0==d.lastIndexOf("_",0)&&sa(a[d])){var e=d.slice(1);if(e in kg){var f=Ga(a[d],function(a){return Math.round(a-c)});
b["all_"+e]=f.join()}delete a[d]}e=!!b.ap;if(f=u("ytglobal.timingReportbuilder_")){if(f=f(a,b,void 0))xg(f,e),yg(),zg(),Ag(!1,void 0),N("TIMING_ACTION")&&M("PREVIOUS_ACTION",N("TIMING_ACTION")),M("TIMING_ACTION","")}else{var g=N("CSI_SERVICE_NAME","youtube");f={v:2,s:g,action:N("TIMING_ACTION",void 0)};var h=b.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var l=window.location.protocol+u("ytplayer.config.assets.js");(l=V.getEntriesByName?V.getEntriesByName(l)[0]:null)?b.h5jse=Math.round(b.h5jse-l.responseEnd):
delete b.h5jse}a.aft=tg();Bg()&&"youtube"==g&&(vg(),g=a.vc,l=a.pbs,delete a.aft,b.aft=Math.round(l-g));for(var m in b)"_"!=m.charAt(0)&&(f[m]=b[m]);a.ps=L();b={};m=[];for(d in a)"_"!=d.charAt(0)&&(g=Math.round(a[d]-c),b[d]=g,m.push(d+"."+g));f.rt=m.join(",");(a=u("ytdebug.logTiming"))&&a(f,b);xg(f,e,void 0);cg(ig,new gg(b.aft+(h||0),void 0))}}}
var zg=v(V.clearResourceTimings||V.webkitClearResourceTimings||V.mozClearResourceTimings||V.msClearResourceTimings||V.oClearResourceTimings||pa,V);
function xg(a,b,c){if(Q("debug_csi_data")){var d=u("yt.timing.csiData");d||(d=[],t("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}d="";for(var e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b)try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,"")||he(a,void 0)}catch(f){he(a,void 0)}else he(a);Ag(!0,c)}
function sg(){var a=wg().nonce;if(!a){a:{if(window.crypto&&window.crypto.getRandomValues)try{var b=Array(16),c=new Uint8Array(16);window.crypto.getRandomValues(c);for(a=0;a<b.length;a++)b[a]=c[a];var d=b;break a}catch(e){}d=Array(16);for(b=0;16>b;b++){c=y();for(a=0;a<c%23;a++)d[b]=Math.random();d[b]=Math.floor(256*Math.random())}if(jg)for(b=1,c=0;c<jg.length;c++)d[b%16]=d[b%16]^d[(b-1)%16]/4^jg.charCodeAt(c),b++}b=[];for(c=0;c<d.length;c++)b.push("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_".charAt(d[c]&
...
;function Cg(a,b){G.call(this);this.o=this.j=a;this.O=b;this.A=!1;this.g={};this.U=this.N=null;this.J=new I;ec(this,x(fc,this.J));this.i={};this.G=this.V=this.h=this.da=this.b=null;this.R=!1;this.H=this.w=this.m=this.M=null;this.W={};this.ua=["onReady"];this.S=new yf(this);ec(this,x(fc,this.S));this.ba=null;this.ka=NaN;this.T={};Dg(this);this.C("onDetailedError",v(this.La,this));this.C("onTabOrderChange",v(this.wa,this));this.C("onTabAnnounce",v(this.la,this));this.C("WATCH_LATER_VIDEO_ADDED",v(this.Ma,
...
n(Cg,G);k=Cg.prototype;k.ja=function(a,b){this.f||(Eg(this,a),Fg(this,b),this.A&&Gg(this))};
function Eg(a,b){a.da=b;a.b=xf(b);a.h=a.b.attrs.id||a.h;"video-player"==a.h&&(a.h=a.O,a.b.attrs.id=a.O);a.o.id==a.h&&(a.h+="-player",a.b.attrs.id=a.h);a.b.args.enablejsapi="1";a.b.args.playerapiid=a.O;a.V||(a.V=Hg(a,a.b.args.jsapicallback||"onYouTubePlayerReady"));a.b.args.jsapicallback=null;var c=a.b.attrs.width;c&&(a.o.style.width=Gb(Number(c)||c));if(c=a.b.attrs.height)a.o.style.height=Gb(Number(c)||c)}
...
function Jg(a,b){var c=a.b,d=c&&c.args&&c.args.fflags;!d||0>d.indexOf("web_player_flash_fallback_killswitch=true")||b&&(5!=(Hf[b.errorCode]||5)||-1==Kg.indexOf(b.errorCode))||!Ig(a)||((d=W(a))&&d.stopVideo&&d.stopVideo(),d&&d.getUpdatedConfigurationData&&(c=d.getUpdatedConfigurationData(),c=wf(c)),c.args.autoplay=1,c.args.html5_unavailable="1",Eg(a,c),Fg(a,"flash"))}
function Fg(a,b){if(!a.f){if(!b){var c;if(!(c=!a.b.html5&&Ig(a))){if(!q(a.b.disable.html5)){c=!0;void 0!=a.b.args.deviceHasDisplay&&(c=a.b.args.deviceHasDisplay);if(c=2.2==Jf?!0:!Sf(c))c=Lg(a)||a.b.assets.js;a.b.disable.html5=!c;c||(a.b.args.html5_unavailable="1")}c=!!a.b.disable.html5}b=c?Ig(a)?"flash":"unsupported":"html5"}("flash"==b?a.bb:a.cb).call(a)}}
function Lg(a){var b=!0,c=W(a);c&&a.b&&(a=a.b,b=od(c,"version")==a.assets.js);return b&&!!u("yt.player.Application.create")}
k.cb=function(){if(!this.R){var a=Lg(this);if(a&&"html5"==Mg(this))this.G="html5",this.A||this.L();else if(Ng(this),this.G="html5",a&&this.m)this.j.appendChild(this.m),this.L();else{this.b.loaded=!0;var b=!1;this.M=v(function(){b=!0;var a=this.j,d=xf(this.b);u("yt.player.Application.create")(a,d);this.L()},this);
this.R=!0;a?this.M():(Kd(this.b.assets.js,this.M),Df(this.b.assets.css),Og(this)&&!b&&t("yt.player.Application.create",null,void 0))}}};
k.bb=function(){var a=xf(this.b);if(!this.w){var b=W(this);b&&(this.w=document.createElement("SPAN"),this.w.tabIndex=0,zf(this.S,this.w,"focus",this.oa),this.H=document.createElement("SPAN"),this.H.tabIndex=0,zf(this.S,this.H,"focus",this.oa),b.parentNode&&b.parentNode.insertBefore(this.w,b),b.parentNode&&b.parentNode.insertBefore(this.H,b.nextSibling))}a.attrs.width=a.attrs.width||"100%";a.attrs.height=a.attrs.height||"100%";if("flash"==Mg(this))this.G="flash",this.A||this.L();else{Ng(this);this.G=
...
k.L=function(){if(!this.f){var a=W(this),b=!1;try{a&&a.getApiInterface&&a.getApiInterface()&&(b=!0)}catch(f){}if(b)if(this.R=!1,a.isNotServable&&a.isNotServable(this.b.args.video_id))Jg(this);else{Dg(this);this.A=!0;a=W(this);a.addEventListener&&(this.N=Pg(this,a,"addEventListener"));a.removeEventListener&&(this.U=Pg(this,a,"removeEventListener"));b=a.getApiInterface();b=b.concat(a.getInternalApiInterface());for(var c=0;c<b.length;c++){var d=b[c];this.g[d]||(this.g[d]=Pg(this,a,d))}for(var e in this.i)this.N(e,
this.i[e]);Gg(this);this.V&&this.V(this.g);this.J.K("onReady",this.g)}else this.ka=R(v(this.L,this),50)}};
function Pg(a,b,c){var d=b[c];return function(){try{return a.ba=null,d.apply(b,arguments)}catch(e){"Bad NPObject as private data!"!=e.message&&"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.ba=e,P(e,"WARNING"))}}}
function Dg(a){a.A=!1;if(a.U)for(var b in a.i)a.U(b,a.i[b]);for(var c in a.T)window.clearTimeout(parseInt(c,10));a.T={};a.N=null;a.U=null;for(var d in a.g)a.g[d]=null;a.g.addEventListener=v(a.C,a);a.g.removeEventListener=v(a.Sa,a);a.g.destroy=v(a.dispose,a);a.g.getLastError=v(a.Aa,a);a.g.getPlayerType=v(a.Ba,a);a.g.getCurrentVideoConfig=v(a.za,a);a.g.loadNewVideoConfig=v(a.ja,a);a.g.isReady=v(a.Ha,a)}
k.Ha=function(){return this.A};
k.C=function(a,b){if(!this.f){var c=Hg(this,b);if(c){if(!(0<=Fa(this.ua,a)||this.i[a])){var d=Qg(this,a);this.N&&this.N(a,d)}this.J.subscribe(a,c);"onReady"==a&&this.A&&R(x(c,this.g),0)}}};
...
function Qg(a,b){var c="ytPlayer"+b+a.O,d=v(function(a){if("html5"==Mg(this)){var c=this.b&&this.b.args&&this.b.args.fflags;if(c&&0>c.indexOf("use_html5_player_event_timeout=true")){this.J.K(b,a);return}}var d=R(v(function(){if(!this.f){this.J.K(b,a);var c=this.T,e=String(d);e in c&&delete c[e]}},this),0);
...
k.Ba=function(){return this.G||Mg(this)};
k.Aa=function(){return this.ba};
function Mg(a){return(a=W(a))?"div"==a.tagName.toLowerCase()?"html5":"flash":null}
function Ng(a){pg("dcp");a.cancel();Dg(a);a.G=null;a.b&&(a.b.loaded=!1);var b=W(a);"html5"==Mg(a)?Lg(a)||!Og(a)?a.m=b:(b&&b.destroy&&b.destroy(),a.m=null):b&&b.destroy&&b.destroy();b=a.j;for(var c;c=b.firstChild;)b.removeChild(c);Af(a.S);a.w=null;a.H=null}
k.cancel=function(){this.M&&Jd(this.b.assets.js,this.M);window.clearTimeout(this.ka);this.R=!1};
k.l=function(){Ng(this);if(this.m&&this.b&&this.m.destroy)try{this.m.destroy()}catch(b){P(b)}this.W=null;for(var a in this.i)p[this.i[a]]=null;this.da=this.b=this.g=null;delete this.j;delete this.o;G.prototype.l.call(this)};
function Og(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
var Kg=["fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];var Rg={},Sg="player_uid_"+(1E9*Math.random()>>>0);function Tg(a){delete Rg[a.O]}
function Ug(a){var b="player";b=r(b)?Ab(b):b;a=wf(a);var c=Sg+"_"+(b[xa]||(b[xa]=++ya)),d=Rg[c];if(d)return d.ja(a),d.g;d=new Cg(b,c);Rg[c]=d;Ad("player-added",d.g);ec(d,x(Tg,d));R(function(){d.ja(a)},0);
return d.g}
;function Vg(a,b,c){if(wa(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function Wg(a,b,c){r(a)&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return Vg(a)}
function Xg(a,b,c,d){if(wa(a)&&!sa(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};r(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
...
function Yg(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
;function Zg(a){G.call(this);this.g=a;this.g.subscribe("command",this.ra,this);this.h={};this.i=!1}
z(Zg,G);k=Zg.prototype;k.start=function(){this.i||this.f||(this.i=!0,$g(this.g,"RECEIVING"))};
k.ra=function(a,b){if(this.i&&!this.f){var c=b||{};switch(a){case "addEventListener":if(r(c.event)&&(c=c.event,!(c in this.h))){var d=v(this.Ua,this,c);this.h[c]=d;this.addEventListener(c,d)}break;case "removeEventListener":r(c.event)&&ah(this,c.event);break;default:this.b.isReady()&&this.b[a]&&(c=bh(a,b||{}),c=this.b[a].apply(this.b,c),(c=ch(a,c))&&this.i&&!this.f&&$g(this.g,a,c))}}};
k.Ua=function(a,b){this.i&&!this.f&&$g(this.g,a,this.ea(a,b))};
k.ea=function(a,b){if(null!=b)return{value:b}};
function ah(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
k.l=function(){var a=this.g;a.f||Nc(a.b,"command",this.ra,this);this.g=null;for(var b in this.h)ah(this,b);Zg.u.l.call(this)};function Y(a,b){Zg.call(this,b);this.b=a;this.start()}
z(Y,Zg);Y.prototype.addEventListener=function(a,b){this.b.addEventListener(a,b)};
Y.prototype.removeEventListener=function(a,b){this.b.removeEventListener(a,b)};
function bh(a,b){switch(a){case "loadVideoById":return b=Vg(b),X(b),[b];case "cueVideoById":return b=Vg(b),X(b),[b];case "loadVideoByPlayerVars":return X(b),[b];case "cueVideoByPlayerVars":return X(b),[b];case "loadPlaylist":return b=Xg(b),X(b),[b];case "cuePlaylist":return b=Xg(b),X(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];
...
Y.prototype.l=function(){Y.u.l.call(this);delete this.b};function dh(a,b,c,d){G.call(this);this.g=b||null;this.o="*";this.h=c||null;this.sessionId=null;this.channel=d||null;this.A=!!a;this.m=v(this.w,this);window.addEventListener("message",this.m)}
n(dh,G);
dh.prototype.w=function(a){if(!("*"!=this.h&&a.origin!=this.h||this.g&&a.source!=this.g)&&r(a.data)){try{var b=nc(a.data)}catch(c){return}if(!(null==b||this.A&&(this.sessionId&&this.sessionId!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin?this.h=this.o=a.origin:P(Error("MessageEvent origin is null"),"WARNING");this.g=a.source;this.sessionId=b.id;this.b&&(this.b(),this.b=null);break;case "command":this.i&&(!this.j||0<=Fa(this.j,b.func))&&this.i(b.func,
b.args)}}};
dh.prototype.sendMessage=function(a,b){var c=b||this.g;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=oc(a);c.postMessage(d,this.o)}catch(e){P(e,"WARNING")}}};
dh.prototype.l=function(){window.removeEventListener("message",this.m);G.prototype.l.call(this)};function eh(a,b,c){dh.call(this,a,b,c||N("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.j=this.b=this.i=null}
n(eh,dh);function fh(){var a=!!N("WIDGET_ID_ENFORCE");a=this.f=new eh(a);var b=v(this.Ra,this);a.i=b;a.j=null;this.f.channel="widget";if(a=N("WIDGET_ID"))this.f.sessionId=a;this.h=[];this.j=!1;this.i={}}
k=fh.prototype;k.Ra=function(a,b){if("addEventListener"==a&&b){var c=b[0];this.i[c]||"onReady"==c||(this.addEventListener(c,gh(this,c)),this.i[c]=!0)}else this.ta(a,b)};
k.ta=function(){};
function gh(a,b){return v(function(a){this.sendMessage(b,a)},a)}
...
function hh(a,b){a.sendMessage("infoDelivery",b)}
k.sa=function(a){this.j?this.f.sendMessage(a):this.h.push(a)};
k.sendMessage=function(a,b){this.sa({event:a,info:void 0==b?null:b})};
k.dispose=function(){this.f=null};function ih(a){fh.call(this);this.b=a;this.g=[];this.addEventListener("onReady",v(this.Oa,this));this.addEventListener("onVideoProgress",v(this.Ya,this));this.addEventListener("onVolumeChange",v(this.Za,this));this.addEventListener("onApiChange",v(this.Ta,this));this.addEventListener("onPlaybackQualityChange",v(this.Va,this));this.addEventListener("onPlaybackRateChange",v(this.Wa,this));this.addEventListener("onStateChange",v(this.Xa,this))}
z(ih,fh);k=ih.prototype;k.ta=function(a,b){if(this.b[a]){b=b||[];if(0<b.length&&Yg(a)){var c=b;if(wa(c[0])&&!sa(c[0]))c=c[0];else{var d={};switch(a){case "loadVideoById":case "cueVideoById":d=Vg.apply(window,c);break;case "loadVideoByUrl":case "cueVideoByUrl":d=Wg.apply(window,c);break;case "loadPlaylist":case "cuePlaylist":d=Xg.apply(window,c)}c=d}X(c);b.length=1;b[0]=c}this.b[a].apply(this.b,b);Yg(a)&&hh(this,this.fa())}};
...
mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());this.b.getStoryboardFormat&&(a.storyboardFormat=this.b.getStoryboardFormat());hh(this,a)};
k.Va=function(a){hh(this,{playbackQuality:a})};
k.Wa=function(a){hh(this,{playbackRate:a})};
...
k.Za=function(){hh(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
k.Ya=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:y()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());hh(this,a)};
k.dispose=function(){ih.u.dispose.call(this);for(var a=0;a<this.g.length;a++){var b=this.g[a];this.b.removeEventListener(b.eventType,b.listener)}this.g=[]};function jh(){G.call(this);this.b=new I;ec(this,x(fc,this.b))}
z(jh,G);jh.prototype.subscribe=function(a,b,c){return this.f?0:this.b.subscribe(a,b,c)};
jh.prototype.D=function(a){return this.f?!1:this.b.D(a)};
jh.prototype.j=function(a,b){this.f||this.b.K.apply(this.b,arguments)};function kh(a,b,c){jh.call(this);this.g=a;this.h=b;this.i=c}
z(kh,jh);function $g(a,b,c){if(!a.f){var d=a.g;d.f||a.h!=d.b||(a={id:a.i,command:b},c&&(a.data=c),d.b.postMessage(oc(a),d.h))}}
kh.prototype.l=function(){this.h=this.g=null;kh.u.l.call(this)};function lh(a,b,c){G.call(this);this.b=a;this.h=c;this.i=Ae(window,"message",v(this.j,this));this.g=new kh(this,a,b);ec(this,x(fc,this.g))}
z(lh,G);lh.prototype.j=function(a){var b;if(b=!this.f)if(b=a.origin==this.h)a:{b=this.b;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(a=a.data,r(a))){try{a=nc(a)}catch(d){return}a.command&&(b=this.g,b.f||b.j("command",a.command,a.data))}};
lh.prototype.l=function(){Be(this.i);this.b=null;lh.u.l.call(this)};function mh(){var a=Pa(window,"settings","experiments","flags","html5_serverside_pagead_id_sets_cookie")||N("EXP_HTML5_SERVERSIDE_PAGEAD_ID_SETS_COOKIE",!1)||Q("html5_serverside_pagead_id_sets_cookie")?"//googleads.g.doubleclick.net/pagead/id?exp=nomnom":"//googleads.g.doubleclick.net/pagead/id",b=Ua(nh);return new H(function(c,d){b.P=function(a){Sd(a)?c(a):d(new oh("Request failed, status="+a.status,"net.badstatus"))};
b.onError=function(){d(new oh("Unknown request error","net.unknown"))};
b.Z=function(){d(new oh("Request timed out","net.timeout"))};
Zd(a,b)})}
var ph={eb:"net.badstatus",fb:"net.retryexhausted",TIMEOUT:"net.timeout",UNKNOWN:"net.unknown"};function oh(a,b){B.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
n(oh,B);var qh=oh;function rh(a){this.g=void 0===a?null:a;this.f=0;this.b=null}
rh.prototype.then=function(a,b,c){return this.g?this.g.then(a,b,c):1===this.f&&a?(a=a.call(c,this.b),vc(a)?a:sh(a)):2===this.f&&b?(a=b.call(c,this.b),vc(a)?a:th(a)):this};
rh.prototype.getValue=function(){return this.b};
uc(rh);function th(a){var b=new rh;a=void 0===a?null:a;b.f=2;b.b=void 0===a?null:a;return b}
function sh(a){var b=new rh;a=void 0===a?null:a;b.f=1;b.b=void 0===a?null:a;return b}
;function uh(a){B.call(this,a.message||a.description||a.name);this.isMissing=a instanceof vh;this.isTimeout=a instanceof qh&&a.errorCode==ph.TIMEOUT;this.isCanceled=a instanceof Dc}
n(uh,B);uh.prototype.name="BiscottiError";function vh(){B.call(this,"Biscotti ID is missing from server")}
n(vh,B);vh.prototype.name="BiscottiMissingError";var nh={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},wh=null;function xh(){if("1"===Pa(N("PLAYER_CONFIG",{}),"args","privembed"))return Ac(Error("Biscotti ID is not available in private embed mode"));wh||(wh=Cc(mh().then(yh),function(a){return zh(2,a)}));
return wh}
function yh(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new vh;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new vh;a=a.id;Ah(a);wh=sh(a);Bh(18E5,2);return a}
function zh(a,b){var c=new uh(b);Ah("");wh=th(c);0<a&&Bh(12E4,a-1);throw c;}
function Bh(a,b){R(function(){Cc(mh().then(yh,function(a){return zh(b,a)}),pa)},a)}
function Ah(a){t("yt.ads.biscotti.lastId_",a,void 0)}
;function Ch(){}
function Dh(a){if("1"!==Pa(N("PLAYER_CONFIG",{}),"args","privembed")){a&&!u("yt.ads.biscotti.getId_")&&t("yt.ads.biscotti.getId_",xh,void 0);try{try{var b=u("yt.ads.biscotti.getId_");var c=b?b():xh()}catch(d){c=Ac(d)}c.then(Eh,Ch);R(Dh,18E5)}catch(d){P(d)}}}
var Fh=0;
function Eh(a){a:{try{var b=window.top.location.href}catch(Ma){b=2;break a}b=null!=b?b==window.document.location.href?0:1:2}b={dt:Hb,flash:hd||"0",frm:b};b.u_tz=-(new Date).getTimezoneOffset();var c=void 0===c?A:c;try{var d=c.history.length}catch(Ma){d=0}b.u_his=d;b.u_java=!!A.navigator&&"unknown"!==typeof A.navigator.javaEnabled&&!!A.navigator.javaEnabled&&A.navigator.javaEnabled();A.screen&&(b.u_h=A.screen.height,b.u_w=A.screen.width,b.u_ah=A.screen.availHeight,b.u_aw=A.screen.availWidth,b.u_cd=
...
Ba.mozVisibilityState||Ba.visibilityState||""]||0,wgl:!!A.WebGLRenderingContext};for(var rd in va)b[rd]=va[rd]}b.bsq=Fh++;ee("//www.youtube.com/ad_data_204",{Ca:!1,B:b})}
;function Gh(){this.b=N("ALT_PREF_COOKIE_NAME","PREF");var a=Nb.get(""+this.b,void 0);if(a){a=unescape(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
qa(Gh);var Z=u("yt.prefs.UserPrefs.prefs_")||{};t("yt.prefs.UserPrefs.prefs_",Z,void 0);function Hh(a){if(/^f([1-9][0-9]*)$/.test(a))throw Error("ExpectedRegexMatch: "+a);}
function Ih(a){if(!/^\w+$/.test(a))throw Error("ExpectedRegexMismatch: "+a);}
function Jh(a){a=void 0!==Z[a]?Z[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
Gh.prototype.get=function(a,b){Ih(a);Hh(a);var c=void 0!==Z[a]?Z[a].toString():null;return null!=c?c:b?b:""};
Gh.prototype.set=function(a,b){Ih(a);Hh(a);if(null==b)throw Error("ExpectedNotNull");Z[a]=b.toString()};
Gh.prototype.remove=function(a){Ih(a);Hh(a);delete Z[a]};
Gh.prototype.clear=function(){Z={}};var Kh=null,Lh=null,Mh=null,Nh={};function Oh(a){Ve(a.payload_name,a.payload,Ye,void 0,void 0)}
function Ph(a){var b=a.id;a=a.ve_type;var c=Ge++;a=new Fe(void 0,a,c,void 0,void 0);Nh[b]=a;b=ff();c=ef();b&&c&&We(b,c,a)}
function Qh(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(M("client-screen-nonce",b),M("ROOT_VE_TYPE",a),a=ef()))for(var c in Nh){var d=Nh[c];d&&We(b,a,d)}}
function Rh(a){Nh[a.id]=new Fe(a.tracking_params)}
function Sh(a){var b=ff();a=Nh[a.id];b&&a&&Xe(Ye,{click:{csn:b,visualElement:He(a)}},void 0)}
function Th(a){a=a.ids;var b=ff();if(b){for(var c=[],d=0;d<a.length;d++){var e=Nh[a[d]];e&&c.push(e)}c.length&&Ze(b,c)}}
function Uh(){var a=Kh;a&&a.startInteractionLogging&&a.startInteractionLogging()}
...
t("writeEmbed",function(){var a=N("PLAYER_CONFIG",void 0);Dh(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=N("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);N("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&X(a.args);Kh=a=Ug(a);a.addEventListener("onScreenChanged",Qh);a.addEventListener("onLogClientVeCreated",Ph);a.addEventListener("onLogServerVeCreated",Rh);a.addEventListener("onLogToGel",Oh);
a.addEventListener("onLogVeClicked",Sh);a.addEventListener("onLogVesShown",Th);a.addEventListener("onReady",Uh);b=N("POST_MESSAGE_ID","player");N("ENABLE_JS_API")?Mh=new ih(a):N("ENABLE_POST_API")&&r(b)&&r(c)&&(Lh=new lh(window.parent,b,c),Mh=new Y(a,Lh.g));N("BG_P")&&(N("BG_I")||N("BG_IU"))&&Md();se()},void 0);
t("yt.www.watch.ads.restrictioncookie.spr",function(a){he(a+"mac_204?action_fcts=1");return!0},void 0);
var Vh=ld(function(){pg("ol");var a=Gh.getInstance(),b=1<window.devicePixelRatio;if(!!((Jh("f"+(Math.floor(119/31)+1))||0)&67108864)!=b){var c="f"+(Math.floor(119/31)+1),d=Jh(c)||0;d=b?d|67108864:d&-67108865;0==d?delete Z[c]:Z[c]=d.toString(16).toString();a=a.b;b=[];for(var e in Z)b.push(e+"="+escape(Z[e]));gf(a,b.join("&"),63072E3)}}),Wh=ld(function(){var a=Kh;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();N("PL_ATT")&&(Ld=null);a=0;for(var b=qe.length;a<b;a++)pe(qe[a]);qe.length=0;Id("//static.doubleclick.net/instream/ad_status.js");re=!1;M("DCLKSTAT",0);gc(Mh,Lh);if(a=Kh)a.removeEventListener("onScreenChanged",Qh),a.removeEventListener("onLogClientVeCreated",Ph),a.removeEventListener("onLogServerVeCreated",Rh),a.removeEventListener("onLogToGel",Oh),a.removeEventListener("onLogVeClicked",Sh),a.removeEventListener("onLogVesShown",Th),a.removeEventListener("onReady",
Uh),a.destroy();Nh={}});
window.addEventListener?(window.addEventListener("load",Vh),window.addEventListener("unload",Wh)):window.attachEvent&&(window.attachEvent("onload",Vh),window.attachEvent("onunload",Wh));}).call(this);
