...
if (isset($_GET['CmdLog'])) {
    ...
    <br>
    <a class="Button" href='Remote.php?CmdLog=1&Page=<?php echo ($Page - 1); ?>'>Previous Page</a> 
    ...
    <a class="Button" href='Remote.php?CmdLog=1&Page=<?php echo ($Page + 1); ?>'>Next Page</a>
    <br>
    <br>
    <?php
    if (mysqli_num_rows($rows) == 0) {
    ...
    <br>
    <a class="Button" href='Remote.php?CmdLog=1&Page=<?php echo ($Page - 1); ?>'>Previous Page</a> 
    &nbsp  &nbsp <a class="Button" href='Remote.php?CmdLog=1'>MainPage</a> &nbsp &nbsp
    <a class="Button" href='Remote.php?CmdLog=1&Page=<?php echo ($Page + 1); ?>'>Next Page</a><br>
    <?php
}
...
if (isset($_GET['SSLog'])) {
    ...
    $Page = (isset($_GET['Page'])) ? $Utils->FormatString($_GET['Page']) : 0;
    ?>
    <a class="Button" href='Remote.php?SSLog=1&Page=<?php echo ($Page - 1); ?>'>Previous Page</a> 
    ...
    <a class="Button" href='Remote.php?SSLog=1&Page=<?php echo ($Page + 1); ?>'>Next Page</a>
    <?php
    $Limit = 2;
    $Limit2 = ($Limit * $Page);
    ...
    ?>
    <a class="Button" href='Remote.php?SSLog=1&Page=<?php echo ($Page - 1); ?>'>Previous Page</a> 
    &nbsp  &nbsp <a class="Button" href='Remote.php?SSLog=1'>MainPage</a> &nbsp &nbsp
    <a class="Button" href='Remote.php?SSLog=1&Page=<?php echo ($Page + 1); ?>'>Next Page</a><br>
    <?php
}
