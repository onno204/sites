<?php
class MySQLOnno204CommandsSpelers {
    function MySQLOnno204CommandsSpelers(){
        $this->Username = "udzotgxc_Mijnstad";
        $this->Password = "MijnstadMijnstad 1";
        $this->Database = "udzotgxc_Mijnstad";
        $this->URL = "localhost";
        $this->Ideas = "CommandsSpelers";
    }
    ...
    function ShowAllIdeas(){
        ...
        echo ' <table class="IdeasTable" >
                <tr>
                    <th class="IdeasTDTH IdeasSmallType" >Command</th>
                    <th class="IdeasTDTH" >Uitleg</th>
