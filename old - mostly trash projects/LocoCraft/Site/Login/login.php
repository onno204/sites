...
if($username && $password) {
    $connect = mysqli_connect('localhost', 'onno204n_SiteDB', 'SiteDB123') or die ('Couldn\'t Connect');
    ...
    if($numrows){
        ...
        //Lastip
        $LastIPQuery = "UPDATE  `users` SET  `LastIP` =  '". $Utils->get_client_ip() . "' WHERE  `users`.`email` ='". $dbemail ."' AND  `users`.`username` =  '". $dbusername ."'";
