...
<html>
    <head>
        ...
        <?php 
            ...
            echo"<title id='title'>Onno204 - $Selected </title>"; 
        ?>
                        ...
                        <?php
                                ...
                                if( ($Error == FALSE) && (($ReceivedSubmit == "TRUE")) ){
                                    ...
                                    echo '<script>ClearRegisterMenu();</script>';$MysqlClass->UpdateSettings($ReceivedUsername, "email", $ReceivedEMail);
                                        ...
                                        $MysqlClass->UpdateSettings($ReceivedUsername, "phone", $ReceivedPhone);
                                        $MysqlClass->UpdateSettings($ReceivedUsername, "fullname", $ReceivedFullname);
                                        $MysqlClass->UpdateSettings($ReceivedUsername, "about", $ReceivedAbout);
