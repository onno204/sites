...
?>
 ...
 <div class="LevoSynagogeLeft up"> 
    <div class="nothing"><?php
            ...
            require_once '../AddOns/phps/MySQLOnno204Ideas.php';
            $MySQLOnno204Ideas = new MySQLOnno204Ideas();
            echo $MySQLOnno204Ideas->Connect();
            $MySQLOnno204Ideas->CheckConnection();
            $MySQLOnno204Ideas->First();
            ...
            if (!($_COOKIE['idea'] == '') ){
                ...
                $MySQLOnno204Ideas->AddIdea($type, $idea);
                echo '
                    <script>
            ...
            if (!($_COOKIE['RemoveID'] == '') ){
                ...
                $MySQLOnno204Ideas->RemoveIdea($RemoveID);
                echo '
                    <script>
                    ...
                    <div class="IdeasContent">
                        <script>
                            ...
                            <form class="IdeasaddPW">
                                    Type:<input class="AddIdea" id="Type" value="Type" type="text" maxlength="500" required>
                                    Idea:<input class="AddIdea" style="width: 350px;" id="Idea" value="Idea" type="text" maxlength="500" required>
                                    <input onclick="Next()" type="submit" value="Add Idea.">
                            </form>
                    </div>
                ' ;
                $MySQLOnno204Ideas->ShowAllIdeas();
                }
            ?>
        </div>
</div>
