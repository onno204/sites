...
$config =  array(
    ...
    'serverinfo' => [
        ...
        'serveradress' => "http://localhost/clientpanel/",
        ...
        'currentpagelocation' => substr(str_replace('/clientpanel','',pathinfo($_SERVER['SCRIPT_NAME'], PATHINFO_DIRNAME)).'/'.pathinfo(basename($_SERVER['SCRIPT_NAME']), PATHINFO_FILENAME),1),
    ],
